...
const projects = [
  ...
  },
  {
    ...
    longDescription: 'The NetJets Airport Terminal project involved a complete renovation of an existing facility to create a premium private aviation experience. The design emphasizes luxury, efficiency, and brand identity throughout the space. The terminal includes comfortable waiting lounges, private meeting rooms, concierge services, and streamlined processing areas for passengers and crew. Material selections feature a sophisticated palette of natural stone, wood veneers, and metal accents that convey a sense of timeless elegance while incorporating NetJets brand aesthetic. Special attention was paid to lighting design, with a combination of natural daylight and carefully placed artificial lighting creating a warm, welcoming atmosphere. The terminal layout optimizes operational flow while providing discrete, exclusive spaces for high-profile clients.',
    client: 'NetJets Inc.',
    year: '2018',
...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `${project.title} | Bitar Design`,
